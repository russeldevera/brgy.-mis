...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard" class="brand-link">
      ...
      <span class="brand-text font-weight-light">BRGY MIS</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="assets\AdminLTE-3.2.0\dist/img/user8-128x128.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">BRGY Admin</a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="residents_list" class="nav-link">
          ...
          <li class="nav-item">
            <a href="my_account" class="nav-link">
          ...
          <li class="nav-item">
            <a href="brgy_map" class="nav-link active">
...
<div class="content-wrapper">
    ...
    <iframe width="100%" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=barangay%2047b%20cavite%20city+(My%20Business%20Name)&amp;t=&amp;z=17&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.maps.ie/distance-area-calculator.html">area maps</a></iframe>
    </section>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
